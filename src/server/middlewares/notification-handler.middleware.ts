...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Employee Added.create': { roles: ['owner', 'team-lead'], key: 'employee_added', tenantPath: [], userPath: [] },
  'Payroll Processed.update': {
...
const tenantRoles: string[] = ['owner', 'hr-manager', 'employee', 'team-lead', 'payroll-officer'];
